        ...
        <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-10">
          <div className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <div class="rounded-md border border-gray-300 bg-gray-50 p-4 shadow-md w-36">
                  <label for="upload" class="flex flex-col items-center gap-2 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 fill-white stroke-red-500" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
